    ...
    return FB.api('/me', function(resp) {
      ...
      return getSchedule(me.id, function(classes) {
        ...
        if (classes.length > 0) {
          ...
          completed = 0;
          getFriends(cb2);
          return searchClasses(me.id, cb1);
        } else {
          setProgress(0);
...
royksopp = function() {
  ...
  xhr.setRequestHeader('Content-Type', "application/x-www-form-urlencoded");
  return xhr.send("uid=" + me.id + "&days=" + ($('reminder').value));
};
