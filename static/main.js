...
var $, anim_state, checkFriendship, classify, completed, countmutual, current_status, direct_friend, filter, find_position, friends, getFriends, getSchedule, handleMessage, last_popup, old_thresh, processSearch, progressAnimation, progress_value, race, searchClasses, selectors, setProgress, showMutualCount, showMutualMessage, showclass, showsched, showuser, t, uploadClasses,
...
handleMessage = function(status) {
  var c, classes, cls, i, item, items, last, line, lines, msg, name, num, nums, split_regex, tags, uid, _i, _j, _len, _len1, _ref, _ref1;
  ...
  if ((3 < (_ref1 = items.length) && _ref1 < 16)) {
    nums = ((function() {
    ...
    if (!nums || nums.length < 3) {
      items = (function() {
        var _j, _len1, _results;
        _results = [];
        for (c = _j = 0, _len1 = items.length; _j < _len1; c = ++_j) {
          i = items[c];
