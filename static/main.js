...
var $, X, anim_state, checkFriendship, classify, completed, coreParse, countmutual, current_status, direct_friend, filter, find_position, friends, getFriends, getSchedule, handleMessage, last_popup, old_thresh, placeholder_classes, processSearch, progressAnimation, progress_value, race, recognize_classes, searchClasses, selectors, setProgress, showMutualCount, showMutualMessage, showclass, showsched, showuser, t, uploadClasses,
...
handleMessage = function(status) {
  var c, cls, i, item, items, name, num, nums, tags, _i, _len, _ref;
...
coreParse = function(status) {
  var classes, item, items, last, line, lines, msg, split_regex, uid, _i, _len, _ref;
